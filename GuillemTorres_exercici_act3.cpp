...
void a(struct carta vc[], int *posicio, int *contadorAs);
void b(struct carta vc[], int *posicio);
bool c(int puntuacio);
int puntos = 0;
        ...
        if (turno == 0){
          ...
          for (int contadorMano = 0; contadorMano < 52; contadorMano++){
            if (mano[contadorMano].palo != ""){
              a(mano, &contadorMano, &contadorAs);
              num_cartas_mano++;
            }
          }
          repetir = c(puntos);
        ...
        switch (opcion) {
            ...
            case 3:
                ...
                while(puntosMaquina < puntos){
                  ...
                  b(manoMaquina, &carta_mano_maquina);
...
bool c(int puntuacio){
    if (puntos > 21){
                  cout << "\033[1;31mTe has pasado... puntos: " << puntuacio << "\033[0m" << endl;
                  cout << "\033[1;31mHas perdido\033[0m" << endl;
                  return false;
                } else if (puntuacio == 21){
                  cout << "\033[1;33mFELICIDADES tienes " << puntuacio <<  " puntos!(Blackjack)\033[0m" << endl;
                  return false;
                } else {
                  cout << "\033[1;32mTienes " << puntuacio <<" puntos \033[0m" << endl;
                }
}
